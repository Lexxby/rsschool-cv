  ...
  function g(e, t, n) {
    return function (r) {
      (e.innerHTML = r.result),
        ...
        'PRE' === e.parentNode.tagName && (e.parentNode.classList.remove('loading'), e.parentNode.classList.add('rainbow-show')),
        M && M(e, r.lang),
        0 === --t.c && n();
    };
  }
    ...
    for (var n = e.getElementsByTagName('pre'), r = e.getElementsByTagName('code'), a = [], o = [], i = 0, s = n; i < s.length; i += 1) {
      ...
      h(u),
        u.getElementsByTagName('code').length
          ? u.getAttribute('data-trimmed') || (u.setAttribute('data-trimmed', !0), (u.innerHTML = u.innerHTML.trim()))
          : a.push(u);
    }
  ...
  var M,
    Prism = function Prism(e) {
      ...
      function f(r, a, i) {
        function c(e) {
          return (
            r.name && (e = n(r.name, e)), (p[w] = { replace: m[0], with: e }), (h[w] = y), !g && { remaining: a.substr(y - i), offset: y }
          );
        }
        function f(t) {
          var a = m[t];
...
Rainbow.extend('generic', [
  ...
  Rainbow.extend(
    ...
    [
      ...
      { matches: { 1: 'storage.type', 3: 'entity.function' }, pattern: /(var)?(\s|^)(\S+)(?=\s?=\s?function\()/g },
      ...
      {
        matches: { 1: 'storage.type.class', 2: 'entity.name.class', 3: 'storage.modifier.extends', 4: 'entity.other.inherited-class' },
